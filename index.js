...
if(originalFlavors.length ===31){
    console.log("Confirmed it is 31")
}else if(originalFlavors.length<31){
        console.log("No. Infact it is less than 31")
    }else {
    console.log("It is bigger than 31")
}
/*

(1) an array 

Your function should return a boolean TRUE if the length of the array is 31 and 
FALSE if the length of the array is NOT 31.

To save you from having to count the items above, you can assume that length 
of originalFlavors is 31. You may also want to test your function by creating 
and passing an array of a different length, to make sure it returns FALSE if length is not 31. 
...
/* Task 2: Corporate has come to you with an idea for a new flavor: Rainbow 
Sherbert! They think this will be a game changer. You need to modify the array to
 include this flavor. 
...
For example addFlavor("Rainbow Sherbert", originalFlavors) should return ["Rainbow Sherbert",
 "Banana Nut Fudge",..."Vanilla Burnt Almond"] */ 
var originalFlavors =["Banana Nut Fudge","Vanilla Burnt Almond"]
function addFlavor(array,flavor){
    const clonearray = [...array];
    clonearray.unshift(flavor);
...
For example removeLastFlavor(originalFlavors) would return ["Rainbow Sherbert", 
"Banana Nut Fudge",..."Vanilla"]*/ 

function removeLastFlavor(array2){
...
function getFlavorByIndex(array3, index){
    const clonearray3 = [...array3];
    for(var i= 0; i<clonearray3.length; i++){
        if(index>clonearray3.length){
...
var arraytosearch = prompt("which array would you like to index in");
var index = prompt("which array value would you like ");
getFlavorByIndex(arraytosearch, index)
...
For example, removeFlavorByName(originalFlavors, "Vanilla") would return an 
array with the length 30 including all of the flavors except Vanilla. 
...
function removeFlavorByName(arr , string){
    ...
    removeFlavorByName(originalFlavors, 'Banana');
...
item in the array for a given string and returns a new array called filteredArray with 
just these values. Rather than hardcoding "chocolate" into your function, pass a string as a 
parameter, and invoke with the argument "chocolate". This way you could also filter 
...
For example, filterByWord(originalFlavors, "Chocolate") should return ["Chocolate", 
"Chocolate Almond",..."Chocolate Ribbon"].
...
Write a function that will randomly select a total of 31 flavors from originalFlavors, 
currentFlavors, seasonalFlavors, and regionalFlavors.

Your function should accept 4 different arrays,

and should return a new array called randomFlavors with a length 31.

forExample, getRandomFlavors(originalFlavors, newFlavors, seasonalFlavors, regionalFlavors) 
...
function getRandomFlavors(array1){
